...
void			Location::print_info(void) const
{
	...
	std::cout << C_LOCATION << "        index     " << C_RES << ": " << this->get__index() << std::endl;
	std::cout << C_LOCATION << "        autoindex " << C_RES << ": " << SBOOL(this->get__autoindex()) << std::endl;
	std::cout << C_LOCATION << "        upload    " << C_RES << ": " << this->get__upload() << std::endl;
	std::cout << C_LOCATION << "        redir_301 " << C_RES << ": " << this->get__redir301() << std::endl;
	std::cout << C_LOCATION << "        methods   " << C_RES << ": ";
