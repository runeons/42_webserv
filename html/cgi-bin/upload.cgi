...
'''
    ...
    if not form.has_key('file'):
        print '<h1>Not found parameter 1 : file</h1>'
        return

    form_file = form['file']
    if not form_file.file:
        print '<h1>Not found parameter 2 : file</h1>'
        return

    if not form_file.filename:
        print '<h1>Not found parameter 3 : file</h1>'
        return
    ...
    print '''
<hr>
<a href="../contact.html">Back to upload page</a>
</body>
</html>
'''
